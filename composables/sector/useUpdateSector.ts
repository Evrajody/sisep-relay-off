export const useUpdateSector = (refreshSectors: () => void) => {

    const { $sisepApi } = useNuxtApp()

    const updateSector = async (sectorId: string, data: any) => {
        const response = await $sisepApi(`sectors/${sectorId}`, {
            method: 'PUT',
            body: data,
            onResponse: ({ response }) => {
    ...
    const updateSectorFormEl = ref(null)
    const currentSector = ref(null)

    const updateSectorForm = computed(() => ({
        scrollOnNext: true,
        id: "updateSectorForm",
        addClass: "max-w-full",
        displayErrors: true,
        ...
        endpoint: async (form: any, payload: any) => {
            if (currentSector.value?.id) {
                ...
                await updateSector(currentSector.value.id, formattedData)
            }
        },
        ...
        schema: {
            ...
            parentId: {
                ...
                default: currentSector.value?.parentId || '',
                columns: {
            ...
            artefactId: {
                ...
                default: currentSector.value?.artefactId || '',
                columns: {
                    default: { container: 12, label: 12, wrapper: 12 },
                    sm: { container: 12, label: 12, wrapper: 12 },
                    md: { container: 6, label: 12, wrapper: 12 },
            ...
            artefact: {
                ...
                schema: {
                    identifier: {
                        ...
                        rules: ['required'],
                        default: currentSector.value?.artefact?.identifier || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    agencyId: {
                        ...
                        default: currentSector.value?.artefact?.agencyId || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    version: {
                        ...
                        rules: ['required'],
                        default: currentSector.value?.artefact?.version || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    uri: {
                        ...
                        default: currentSector.value?.artefact?.uri || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    urn: {
                        ...
                        default: currentSector.value?.artefact?.urn || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    structureUrl: {
                        ...
                        default: currentSector.value?.artefact?.structureUrl || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    serviceUrl: {
                        ...
                        default: currentSector.value?.artefact?.serviceUrl || '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    isFinal: {
                        ...
                        default: currentSector.value?.artefact?.isFinal || false,
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                    ...
                    isExternal: {
                        ...
                        default: currentSector.value?.artefact?.isExternal || false,
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 4, label: 12, wrapper: 12 },
                    ...
                    isPartial: {
                        ...
                        default: currentSector.value?.artefact?.isPartial || false,
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 4, label: 12, wrapper: 12 },
                    ...
                    validFrom: {
                        ...
                        default: currentSector.value?.artefact?.validFrom || null,
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    validTo: {
                        ...
                        default: currentSector.value?.artefact?.validTo || null,
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 6, label: 12, wrapper: 12 },
                    ...
                    nameJson: {
                        ...
                        rows: 3,
                        default: currentSector.value?.artefact?.nameJson ? JSON.stringify(currentSector.value.artefact.nameJson, null, 2) : '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                    ...
                    descriptionJson: {
                        ...
                        rows: 3,
                        default: currentSector.value?.artefact?.descriptionJson ? JSON.stringify(currentSector.value.artefact.descriptionJson, null, 2) : '',
                        columns: {
                            default: { container: 12, label: 12, wrapper: 12 },
                            sm: { container: 12, label: 12, wrapper: 12 },
                            md: { container: 12, label: 12, wrapper: 12 },
    ...
    const isModalUpdateSectorOpen = ref(false)
    const toggleModalUpdateSector = () => {
        isModalUpdateSectorOpen.value = !isModalUpdateSectorOpen.value
    }

    const openUpdateModal = (sector: any) => {
        currentSector.value = sector
        isModalUpdateSectorOpen.value = true
    }
