        ...
        <div class="relative flex flex-col md:flex-row">
            ...
            <div class="flex-1 p-5 md:p-6 flex flex-col gap-3">
                ...
                <div class="mt-1 md:mt-auto">
                    ...
                    <NuxtLink
                        :to="`/conventions/single/${props.convention.id || '#'}`"
                        class="mt-3 w-fit bg-primary-500 text-white inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-9 px-4 py-2.5 hover:text-white/80 hover:bg-primary-600">
                        Lire la Convention
